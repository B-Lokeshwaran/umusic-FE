...
function Sidebar() {
    ...
    const highLighter = (path) => {
        ...
        if(path === '/applications/AddApp'){
            setSelectedSection('1')
        }
        
        if(path === '/shopifystores/editshop'){
            setSelectedSection('2')
        }
        if(path === '/shopifystores/addshop'){
            setSelectedSection('2')
        }
        if(path === '/authenticationproviders/addnew'){
            setSelectedSection('3')
        }
        if(path === '/authenticationproviders/addauth'){
            setSelectedSection('3')
        }
        if(path === '/providers/addpro'){
            setSelectedSection('4')
        }
                        ...
                        <Col sm={3}>
                            <div className="side">
                                <Card style={{ 'width': '18rem', 'height': '821px', 'marginLeft': '-72px', 'background-color': '#000000' }}>
                                    <Card.Body>
                                     <img src={require('/Users/lokeshwaranbasha/Desktop/umusic FE/src/Assets/umg_logo@2x.png')} style={{'width':'120px', 'marginLeft': '-5px'}}/>   
                                    </Card.Body>
                                    <Accordion activeKey={selectedSection}>
                                        <Accordion.Item eventKey="0">
                                            <Nav.Link href='/'>
                                            <Accordion.Header>
                                            <img src={require('/Users/lokeshwaranbasha/Desktop/umusic FE/src/Assets/Group 197.png')} style={{'width':'25px', 'marginRight': '10px'}}/>Dashboard</Accordion.Header>
                                            </Nav.Link>
                                        </Accordion.Item>
                                        <Accordion.Item eventKey="1">
                                        <Nav.Link href='/applications'>
                                            <Accordion.Header>
                                            <img src={require('/Users/lokeshwaranbasha/Desktop/umusic FE/src/Assets/Group 203.png')} style={{'width':'25px', 'marginRight': '10px'}}/>Applications</Accordion.Header>
                                        </Nav.Link>    
                                        <Nav.Link href='/applications'>
                                            ...
                                            <Nav.Link href='/applications/AddApp'>
                                            <Accordion.Body>
                                                Add New
                                        ...
                                        <Nav.Link href='/shopifystores'>
                                            ...
                                            <Nav.Link href='/shopifystores/addshop'>
                                            <Accordion.Body>
                                                Add New
                                        ...
                                        <Nav.Link href='/authenticationproviders'>
                                            ...
                                            <Nav.Link href="/authenticationproviders/addauth">
                                            <Accordion.Body>
                                                Add New
                                        ...
                                        <Nav.Link href='/providers'>
                                            ...
                                            <Nav.Link href='/providers/addpro'>
                                            <Accordion.Body>
                                                Add New
