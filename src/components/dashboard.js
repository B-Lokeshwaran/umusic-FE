            ...
            <Container>
                <Row>
                    ...
                    <Col sm={9} style={{ 'marginLeft': '-50px', 'marginTop': '-800px' }}>
                        ...
                        <img src={require('/Users/lokeshwaranbasha/Desktop/umusic FE/src/Assets/Group 197.png')}/>
                            <h2 style={{ 'fontWeight': 'normal',marginTop:'-35px',marginLeft:'70px' }}>Dashboard</h2>
                            <hr></hr>
                        </div>
                        <Row xs={2} md={2} lg={8}>
                            <Col>
                                    ...
                                    <div className="head1">
                                        ...
                                        <div className="head12">
                                            ...
                                            <div className="button2">
                                                {/* <Nav.Link href='/applications/editapp'> */}
